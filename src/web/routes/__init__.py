...
from .cloud_mail_tools import router as cloud_mail_router
from .upload.aether_services import router as aether_services_router
...
api_router.include_router(cloud_mail_router, prefix="/cloud-mail", tags=["cloud-mail"])
api_router.include_router(aether_services_router, prefix="/aether-services", tags=["aether-services"])
